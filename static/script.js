...
function init() {
  ...
  addRoom("lobby");
  addRoom("Rololo Channel");
  changeRoom("lobby");
  addMessage("lobby", "Rololo Channel", "tu peux causer mais les msg sont effacés après.", true);
  addMessage("Rololo Channel", "Rololo Channel", "tu peux aussi creer ton channel custom et seul tes potes peuvent y accéder", true);
  addMessage("Rololo Channel", "Rololo Channel", "j coderai un oxo bientot mais la c'est les exams", true);
  ...
  newRoomForm.addEventListener("submit", (e) => {
    ...
    addMessage(room,"Rololo Channel", `guette, ton propre "${room}" channel! Nice c**k.`, true);
  })
